...
if (!$errors) {
	...
	//recipient
	$to = 'Alselec System <info@alselec.com>';
	//sender
	$from = $name . ' <' . $email . '>';

	//subject and the html message
	$subject = 'Alselec.com - Nuevo mensaje' . $name;
	$message = '
	...
	<head></head>
	<body>
		<p>Este es un mensaje enviado a travéz del sitio web <a href="http://www.alselec.com">www.alselec.com</a>
	<table>
	...
	if ($_POST) {
		if ($result) echo '¡Gracias! Hemos recibido su mensaje. <a href="contacto.html">Volver</a>';
...
//if the errors array has values
	...
	echo '<a href="contacto.html">Back</a>';
	exit;
}
